        ...
        <div className="container mx-auto px-4 py-3 md:py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.div 
              ...
              animate="visible"
            >
              <div className="flex flex-col  text-[#0b2241] w-full  space-x-2 md:space-x-3">
                  <h1 className="font-Dancing font-extrabold text-sm md:text-2xl leading-tight">
                    Corporate 
                  </h1>
                  <h2 className="font-inter font-bold text-lg md:text-2xl md:text-end md:w-[150px]">Bankers' </h2>
                  <h2 className="text-sm md:text-2xl font-Dancing text-end md:w-[250px]">Alumni Association</h2>
{/*                 <p className="text-xs md:text-sm text-muted-foreground">25 Years Anniversary</p>
   */}            </div>
            </motion.div>
